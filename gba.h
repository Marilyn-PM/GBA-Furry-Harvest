...
// I am adding other important parameters
#define SCREEN_HEIGHT 160
#define SCREEN_WIDTH 240

//ADDING Timer 0-3 Time registers
...
// We want to count seconds so we want it to tick 60 times (frames) per seoncd
#define TM_FREQ_1 0
...
#define BUSHGREEN COLOR(1, 13, 9)
#define BUSHGREENHIGH COLOR(25, 30, 18)
#define LAVENDER COLOR(23,25,28)
#define EARTHYELLOW COLOR(29,21,12)
#define ROSE COLOR(28,9,18)
#define RUSTRED COLOR(26,7,9)
#define ORANGE COLOR(27,10,5)
#define TEAL COLOR(0,15,16)
#define DARKGREEN COLOR(2,5,2)
#define OLIVE COLOR(20,23,18)
...
// (KEY_DOWN(key, buttons) check if button is being pressed, 
// while !KEY_DOWN(key, oldbuttons) checks it not being pressed previously 
// ---------------------------------------------------------------------------
//                       DMA
// ---------------------------------------------------------------------------
typedef struct
...
void drawBushDMA(int row, int col, int width, int height, volatile u16 color);
